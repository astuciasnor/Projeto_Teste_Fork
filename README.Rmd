...
-   **Atenção**: no momento de fazer Pull Request, você deve ir na branch do Github correspondente àquela que ainda está usando a fim de poder visualizar o botão de solicitação da Pull Request.
...
1.  Acesse o seu repositório no GitHub (Pode ser preciso mudar de branch para acessar o botão de Pull Request)
