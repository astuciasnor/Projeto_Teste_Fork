...
Agora realiza as modificações no arquivo desejado (`login.txt`). Inclua o campo: `digite nome pet.` Após realizar as modificações, adicione-as ao controle de versão e faça o commit:
...
Isso enviará as alterações da nova branch para o repositório remoto, criando a branch `nova-branch` também no GitHub.
